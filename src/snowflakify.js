(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['lodash', 'exports'], function(_, exports) {
            root.Snowflakify = factory(_, exports);
        })
    }
    ...
    // Load as browser global
    else {
        root.Snowflakify = factory(root, {}, root._);
    }
}(this, function(root, Snowflakify, _) {
    ...
    // Construct the Snowflakify object
    _.assign(Snowflakify, {
        ...
        _createSnowflakes: function(opts, n) {
            var flakes = [],
                flake,
                i = 0;
